...
IK_CONFIG="$SCRIPT_DIR/config/ik_configs/xsens_to_e1_jump.json"
#REDIS_HOST="192.168.0.44"                         # ← 改成同网段,Legion 能连到
REDIS_HOST="192.168.123.164"
REDIS_PORT="6379"
...
NO_OFFSET_TO_GROUND="--no-offset-to-ground"
NO_SPINE_OFFSET="--no-spine-offset"
EXTRA_ARGS=""
